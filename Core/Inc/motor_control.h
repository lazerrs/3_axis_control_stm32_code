...
#define LIMIT_UP_Pin_2     GPIO_PIN_9
#define LIMIT_UP_GPIO_Port_2   GPIOB
#define LIMIT_DOWN_Pin_2   GPIO_PIN_8
...
#define LIMIT_UP_Pin_3    GPIO_PIN_9
#define LIMIT_UP_GPIO_Port_3  GPIOB
#define LIMIT_DOWN_Pin_3  GPIO_PIN_8
